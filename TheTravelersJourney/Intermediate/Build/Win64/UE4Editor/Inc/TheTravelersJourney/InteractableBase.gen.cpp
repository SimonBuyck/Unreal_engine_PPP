...
#include "TheTravelersJourney/Public/InteractableBase.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// Cross Module References
	THETRAVELERSJOURNEY_API UClass* Z_Construct_UClass_AInteractableBase_NoRegister();
	THETRAVELERSJOURNEY_API UClass* Z_Construct_UClass_AInteractableBase();
	ENGINE_API UClass* Z_Construct_UClass_AActor();
	UPackage* Z_Construct_UPackage__Script_TheTravelersJourney();
	ENGINE_API UClass* Z_Construct_UClass_AActor_NoRegister();
	THETRAVELERSJOURNEY_API UClass* Z_Construct_UClass_UInteractInterface_NoRegister();
// End Cross Module References
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_AInteractableBase_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_AInteractableBase_EndFocus, "EndFocus" }, // 1225410934
		{ &Z_Construct_UFunction_AInteractableBase_OnInteract, "OnInteract" }, // 2701394541
		{ &Z_Construct_UFunction_AInteractableBase_StartFocus, "StartFocus" }, // 2572217631
	};
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(AInteractableBase, 1193562184);
	template<> THETRAVELERSJOURNEY_API UClass* StaticClass<AInteractableBase>()
	{
		return AInteractableBase::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_AInteractableBase(Z_Construct_UClass_AInteractableBase, &AInteractableBase::StaticClass, TEXT("/Script/TheTravelersJourney"), TEXT("AInteractableBase"), false, nullptr, nullptr, nullptr);
